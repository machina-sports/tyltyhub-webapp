...
const generateTeamInsight = (teamName: string): string => {
  const insights: Record<string, string> = {
    ...
    "Los Angeles FC": "Equipe americana com estilo técnico e dinâmico especialmente nas transições. A equipe se destaca pela qualidade técnica individual de seus atletas e pela capacidade de criar desequilíbrios em jogadas individuais, representando o melhor da MLS.",
    ...
    "Inter de Milão": "Campeão italiano com forte estrutura defensiva e ataque eficiente, especialista em jogos de confronto direto. A equipe nerazzurri mantém a tradição italiana de solidez tática, mas com toques modernos de velocidade e criatividade ofensiva.",
